...
struct FSimpleMGFGameAbilityMapping
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct FSimpleMGFGameAttributesMapping
{
	GENERATED_BODY()

	// Ability set to grant
	UPROPERTY(EditAnywhere, BlueprintReadOnly)
	TSoftClassPtr<USimpleMGFGameAbilityAttributeSet> AttributeSetType;
...
struct FGameFeatureAbilitiesEntry
{
	...
	UPROPERTY(EditAnywhere, Category="Abilities")
	TArray<FSimpleMGFGameAbilityMapping> GrantedAbilities;

	// List of attribute sets to grant to actors of the specified class 
	UPROPERTY(EditAnywhere, Category="Attributes")
	TArray<FSimpleMGFGameAttributesMapping> GrantedAttributes;
};
